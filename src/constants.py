...
_DEFAULT_KEYWORD_ROUTES: tuple[KeywordRoute, ...] = (
    ...
    KeywordRoute(keyword="今日玩法", action="today_status"),
    KeywordRoute(keyword="老婆状态", action="today_status"),
    KeywordRoute(keyword="老婆日报", action="today_status"),
    KeywordRoute(keyword="老婆群友", action="anime_group_friend"),
    KeywordRoute(keyword="抽完老婆抽群友", action="anime_group_friend"),
    KeywordRoute(keyword="老婆搭子", action="anime_group_friend"),
    KeywordRoute(keyword="二次元老婆群友", action="anime_group_friend"),
    ...
    KeywordRoute(keyword="我也日", action="wo_ye_ri"),
